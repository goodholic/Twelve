...
public class LobbySceneManager : MonoBehaviour
{
    ...
    // --------------------------------------------------------------------------------
    // 여기서 "캐릭터 창이 열릴 때 -> CharacterPanelManager.OpenCharacterPanel()" 호출
    // --------------------------------------------------------------------------------
    public void OnClickOpenCharacterPanel()
    {
        ...
        if (characterPanel)
        {
            // (기존) characterPanel.SetActive(true); 대신,
            // CharacterPanelManager의 메서드를 명시적으로 호출
