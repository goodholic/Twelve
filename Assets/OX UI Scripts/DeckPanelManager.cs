...
public class DeckPanelManager : MonoBehaviour
{
    ...
    public void OnClickUse4CardsAtRandom()
    {
        ...
        {
            if (registeredCharactersSet2[i] != null && validTiles.Count > 0)
            {
                // 랜덤 타일 선택
                ...
                {
                    Character summonedCharacter = PlacementManager.Instance.SummonCharacterOnTile(registeredCharactersSet2[i], targetTile, false);
