...
namespace GuildMaster.UI
{
    ...
    public class GameStateUI : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            // resourceManager = GameManager.Instance?.ResourceManager; // Commented out - ResourceManager removed
        ...
        private void UpdateResourceDisplay()
        {
            ...
            // Temporary implementation with default values
            if (goldText != null)
                goldText.text = FormatNumber(0);
                
            if (woodText != null)
                woodText.text = FormatNumber(0);
                
            if (stoneText != null)
                stoneText.text = FormatNumber(0);
                
            if (manaStoneText != null)
                manaStoneText.text = FormatNumber(0);
        }
