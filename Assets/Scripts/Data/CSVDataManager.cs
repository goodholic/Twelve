...
namespace GuildMaster.Data
{
    ...
    public class CSVDataManager : MonoBehaviour
    {
        ...
        private Dictionary<string, BuildingDataCSV> buildingDataDict = new Dictionary<string, BuildingDataCSV>();
        ...
        public BuildingDataCSV GetBuildingData(string id) => buildingDataDict.ContainsKey(id) ? buildingDataDict[id] : null;
        ...
        public List<BuildingDataCSV> GetAllBuildingData() => buildingDataDict.Values.ToList();
