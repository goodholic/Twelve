...
public class CharacterData : ScriptableObject
{
    ...
    [Header("🎬 애니메이션 타입 설정")]
    [SerializeField, Tooltip("스프라이트 또는 PNG 시퀀스 애니메이션 선택")]
    public AnimationType animationType = AnimationType.Sprite;
    

    
    [Header("🖼️ PNG 시퀀스 애니메이션 할당 (Animation Type을 PNGSequence로 설정 시)")]
    [Space(10)]
    [SerializeField, Tooltip("대기 애니메이션 PNG 시퀀스 파일들\n✨ 권장: 투명배경 PNG 파일들\n📁 예: idle_01.png, idle_02.png, idle_03.png...")]
    public Texture2D[] idlePNGSequence;
    
    [Space(5)]
    [SerializeField, Tooltip("공격 애니메이션 PNG 시퀀스 파일들\n✨ 권장: 투명배경 PNG 파일들\n📁 예: attack_01.png, attack_02.png, attack_03.png...")]
    public Texture2D[] attackPNGSequence;
    
    [Space(5)]
    [SerializeField, Tooltip("PNG 시퀀스 재생 프레임레이트 (FPS)\n🎬 권장: 12-24 FPS")]
    [Range(1, 60)]
    public int pngSequenceFrameRate = 12;
    
    [Header("자동 처리")]
    // 모든 다른 애니메이션: idle 또는 attack 재사용
    // Death: 연기 효과로 처리
    
    [Header("🎬 PNG 시퀀스 설정")]
    [SerializeField, Tooltip("PNG 시퀀스 반복 재생 여부")]
    public bool loopPNGSequences = true; // PNG 시퀀스 반복 재생 여부
    [SerializeField, Tooltip("PNG 시퀀스 크기 조절")]
    public float pngSequenceScale = 1.0f; // PNG 시퀀스 크기 조절
...
{
    Sprite,         // 스프라이트 애니메이션 (기존 방식)
    PNGSequence     // PNG 시퀀스 애니메이션 (투명배경, 권장!)
}
