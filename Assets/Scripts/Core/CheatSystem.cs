    ...
    public class CheatSystem : MonoBehaviour
    {
        ...
        void InitializeCheatCommands()
        {
            ...
            RegisterCheat("stats", "show_stats", "게임 통계 표시", (args) => {
                ...
                {
                    stats += $"골드: {ResourceManager.Instance.GetResource(ResourceType.Gold)}\n";
                    stats += $"나무: {ResourceManager.Instance.GetResource(ResourceType.Wood)}\n";
                    stats += $"돌: {ResourceManager.Instance.GetResource(ResourceType.Stone)}\n";
                    stats += $"식량: {ResourceManager.Instance.GetResource(ResourceType.Food)}\n";
                }
