...
namespace GuildMaster.UI
{
    ...
    public class GuildMasterUI : MonoBehaviour
    {
        ...
        private void SubscribeToEvents()
        {
            ...
            {
                // TODO: Update when proper implementation is available
                // OnBuildingConstructed 및 OnResourcesChanged 타입이 제거되어 주석 처리
        ...
        /*
        private void OnBuildingConstructed(GuildBuildingTemp building)
        {
