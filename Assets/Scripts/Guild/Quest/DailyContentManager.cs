...
namespace GuildMaster.Systems
{
    ...
    public enum QuestObjective
    {
        CompleteBattles,
        WinBattles,
        // ExploreDungeons, // Dungeon 기능 제거됨
        RecruitAdventurers,
        UpgradeBuildings,
        CollectResources,
        ReachGuildLevel,
    ...
    public class DailyContentManager : MonoBehaviour
    {
        ...
        void SubscribeToGameEvents()
        {
            ...
            if (gameManager.GuildManager != null)
            {
                ...
                // TODO: Re-enable when building system is properly implemented
        ...
        void GenerateDailyQuests()
        {
            ...
            var questPool = new List<Quest>
            {
                ...
                // new Quest("daily_explore", "던전 탐험가", QuestType.Daily, QuestObjective.ExploreDungeons, 2) // Dungeon 기능 제거됨
                // {
        ...
        public bool ClaimQuestReward(string questId)
        {
            ...
            var gameManager = Core.GameManager.Instance;
            if (gameManager != null && quest.ReputationReward > 0)
            {
                gameManager.GuildManager.AddReputation(quest.ReputationReward);
            }
        ...
        // TODO: Replace GuildBuildingTemp with proper implementation
        /*
        void OnBuildingUpgraded(GuildBuildingTemp building)
        {
