...
public class CharacterDatabase : MonoBehaviour
{
    ...
    public static CharacterDatabase Instance
    {
        get
        {
            if (instance == null)
            {
                ...
                if (instance == null)
                {
                    Debug.LogWarning("[CharacterDatabase] No instance found in scene!");
                }
            }
            return instance;
        }
    ...
    public void RefreshDatabase()
    {
        ...
        {
            Debug.LogWarning("[CharacterDatabase] GameManager.Instance is null during RefreshDatabase");
        }
    }
    ...
    /// 모든 캐릭터 데이터 가져오기
    /// </summary>
    public System.Collections.Generic.List<CharacterData> GetAllCharacters()
    {
        System.Collections.Generic.List<CharacterData> allCharacters = new System.Collections.Generic.List<CharacterData>();
        
        foreach (var charData in currentRegisteredCharacters)
        {
            if (charData != null)
            {
                allCharacters.Add(charData);
            }
        }
