...
namespace GuildMaster.Editor
{
    ...
    public class CSVImporter : EditorWindow
    {
        ...
        [MenuItem("Twelve/📊 Data Management/CSV 임포터")]
        ...
        [MenuItem("Twelve/📊 Data Management/빠른 캐릭터 임포트")]
        ...
        [MenuItem("Twelve/📊 Data Management/빠른 대화 임포트")]
        ...
        [MenuItem("Twelve/📊 Data Management/빠른 건물 임포트")]
        ...
        [MenuItem("Twelve/📊 Data Management/빠른 스킬 임포트")]
