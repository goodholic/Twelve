...
namespace GuildMaster.Editor
{
    ...
    {
        [MenuItem("Twelve/📊 Data Management/CSV 데이터 생성")]
        ...
        void OnGUI()
        {
            ...
            // Building data generation disabled - BuildingData types removed
        ...
        {
            GenerateCharacterData();
            // GenerateBuildingData(); // Disabled - BuildingData types removed
            // GenerateBuildingEffects(); // Disabled - BuildingData types removed
            // GenerateBuildingProduction(); // Disabled - BuildingData types removed
            GenerateSkillData();
        ...
        void GenerateBuildingData()
        {
            ...
            sb.AppendLine("scout_post,정찰대,ScoutPost,Special,1,1,300,200,50,0,45,2,3,\"주변 지역을 정찰하는 시설. 새로운 이벤트를 발견한다.\"");
        ...
        void GenerateBuildingEffects()
        {
            ...
            // sb.AppendLine("scout_post,DungeonDiscovery,0.1,0.05,\"던전 발견 확률이 증가합니다.\""); // Dungeon 기능 제거됨
